...
class cerasus_slam_class {
    ...
    double DT_CONTROLS= 0.025; // seconds, time interval between control signals控制信号之间的时间间隔

    // observation parameters
    double MAX_RANGE= 30.0; // metres
    double DT_OBSERVE= 8*DT_CONTROLS; // seconds, time interval between observations观测信号之间的间隔
